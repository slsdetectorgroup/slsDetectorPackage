...
void init_det(py::module &m) {
    ...
    CppDetectorApi
        ...
        .def(setSpeed, &Detector::setSpeed, py::arg(), py::arg() = Positions{})
        ...
        .def(setClockPhase, &Detector::setClockPhase, py::arg(), py::arg(),
             py::arg() = Positions{})
        .def(getMaxClockPhaseShift, &Detector::getMaxClockPhaseShift, py::arg(),
             py::arg() = Positions{})
        ...
        .def(getClockDivider, &Detector::getClockDivider, py::arg(),
             py::arg() = Positions{})
        .def(setClockDivider, &Detector::setClockDivider, py::arg(), py::arg(),
             py::arg() = Positions{})
        .def(getHighVoltage, &Detector::getHighVoltage, py::arg() = Positions{})
        ...
        .def(selectUDPInterface, &Detector::selectUDPInterface, py::arg(),
             py::arg() = Positions{})
        .def(getSourceUDPIP, &Detector::getSourceUDPIP, py::arg() = Positions{})
        ...
        .def(getDestinationUDPMAC2, &Detector::getDestinationUDPMAC2,
             py::arg() = Positions{})
        .def(setDestinationUDPMAC2, &Detector::setDestinationUDPMAC2, py::arg(),
             py::arg() = Positions{})
        .def(getDestinationUDPPort, &Detector::getDestinationUDPPort,
             py::arg() = Positions{})
        .def(setDestinationUDPPort, &Detector::setDestinationUDPPort, py::arg(),
             py::arg())
        ...
        .def(getTenGigaFlowControl, &Detector::getTenGigaFlowControl,
             py::arg() = Positions{})
        .def(setTenGigaFlowControl, &Detector::setTenGigaFlowControl, py::arg(),
             py::arg() = Positions{})
        ...
        .def(getRxFifoDepth, &Detector::getRxFifoDepth, py::arg() = Positions{})
        ...
        .def(setClientZmqPort, &Detector::setClientZmqPort, py::arg(),
             py::arg())
        .def(getClientZmqIp, &Detector::getClientZmqIp, py::arg() = Positions{})
        ...
        .def(setSubExptime, &Detector::setSubExptime, py::arg(),
             py::arg() = Positions{})
        .def(getSubDeadTime, &Detector::getSubDeadTime, py::arg() = Positions{})
        ...
        .def(setBottom, &Detector::setBottom, py::arg(),
             py::arg() = Positions{})
        .def(getAllTrimbits, &Detector::getAllTrimbits, py::arg() = Positions{})
        ...
        .def(pulsePixel, &Detector::pulsePixel, py::arg(), py::arg(),
             py::arg() = Positions{})
        .def(pulsePixelNMove, &Detector::pulsePixelNMove, py::arg(), py::arg(),
             py::arg() = Positions{})
        ...
        .def(getTemperatureControl, &Detector::getTemperatureControl,
             py::arg() = Positions{})
        .def(setTemperatureControl, &Detector::setTemperatureControl, py::arg(),
             py::arg() = Positions{})
        ...
        .def(getExptimeLeft, &Detector::getExptimeLeft, py::arg() = Positions{})
        ...
        .def(setNumberOfDigitalSamples, &Detector::setNumberOfDigitalSamples,
             py::arg(), py::arg() = Positions{})
        .def(getReadoutMode, &Detector::getReadoutMode, py::arg() = Positions{})
        ...
        .def(getDBITPhaseInDegrees, &Detector::getDBITPhaseInDegrees,
             py::arg() = Positions{})
        .def(setDBITPhaseInDegrees, &Detector::setDBITPhaseInDegrees, py::arg(),
             py::arg() = Positions{})
        ...
        .def(getADCPipeline, &Detector::getADCPipeline, py::arg() = Positions{})
        ...
        .def(setPatternWaitTime, &Detector::setPatternWaitTime, py::arg(),
             py::arg(), py::arg() = Positions{})
        .def(getPatternMask, &Detector::getPatternMask, py::arg() = Positions{})
        ...
        .def(setAdditionalJsonHeader, &Detector::setAdditionalJsonHeader,
             py::arg(), py::arg() = Positions{})
        .def(getAdditionalJsonParameter, &Detector::getAdditionalJsonParameter,
             py::arg(), py::arg() = Positions{})
        .def(setAdditionalJsonParameter, &Detector::setAdditionalJsonParameter,
             py::arg(), py::arg(), py::arg() = Positions{})
        ...
        .def(executeFirmwareTest, &Detector::executeFirmwareTest,
             py::arg() = Positions{})
        .def(executeBusTest, &Detector::executeBusTest, py::arg() = Positions{})
        .def(writeAdcRegister, &Detector::writeAdcRegister, py::arg(),
             py::arg(), py::arg() = Positions{})
        .def(getControlPort, &Detector::getControlPort, py::arg() = Positions{})
        ...
        .def(executeCommand, &Detector::executeCommand, py::arg(),
             py::arg() = Positions{})
        .def(getNumberOfFramesFromStart, &Detector::getNumberOfFramesFromStart,
             py::arg() = Positions{})
        ...
        .def(getRxCurrentFrameIndex, &Detector::getRxCurrentFrameIndex,
             py::arg() = Positions{})
        .def(getPortNumbers, &Detector::getPortNumbers, py::arg())
}
