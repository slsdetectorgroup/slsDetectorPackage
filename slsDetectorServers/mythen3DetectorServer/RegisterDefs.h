...
#define PATTERN_LOOPDEF_NWORDS          (5)
#define PATTERN_WAIT_TIMER_LSB_WORD     (0)
#define PATTERN_WAIT_TIMER_MSB_WORD     (1)
#define PATTERN_WAIT_ADDR_WORD          (2)
#define PATTERN_LOOP_ITERATION_WORD     (3)
#define PATTERN_LOOP_ADDR_WORD          (4)
