...
class DetectorImpl : public virtual slsDetectorDefs {
  public:
    ...
    void parallelCall(void (sls::Module::*somefunc)(CT...),
                      typename NonDeduced<CT>::type... Args);

    template <typename... CT>
    void parallelCall(void (sls::Module::*somefunc)(CT...) const,
                      typename NonDeduced<CT>::type... Args) const;
     ...
     * @returns OK or FAIL
     */
    int update(const std::string &sname, const std::string &hostname,
