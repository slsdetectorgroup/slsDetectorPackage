...
class Module : public virtual slsDetectorDefs {
  public:
     ...
     * @param slsId ModuleId or position of Module in detectors list
     */
     ...
     * @returns OK or FAIL
     */
    int writeConfigurationFile(const std::string &fname, DetectorImpl *m);

    /**
     * Write current configuration to a stream
     * @param outfile outstream
     * @param m DetectorImpl reference to parse commands
     * @returns OK or FAIL
     */
    int writeConfigurationFile(std::ofstream &outfile, DetectorImpl *m);
     ...
     * @returns OK or FAIL
     */
    int copyDetectorServer(const std::string &fname,
    ...
    /**
     updates the shared memory receiving the data from the detector (without
     asking and closing the connection /returns OK
         */
