...
os << R"V0G0N([name] 
		[ChipTestBoard] Get the adc index for the given name. )V0G0N" << std::endl;
return os.str();
}
...
if (action == slsDetectorDefs::GET_ACTION) {
if (args.size() == 1) {
if (det->getDetectorType().squash() != defs::CHIPTESTBOARD) { throw RuntimeError(cmd + " only allowed for CTB."); }
...
os << R"V0G0N([adcname1 adcname2 .. adcname32] 
		[ChipTestBoard] Set the list of adc names for this board. )V0G0N" << std::endl;
return os.str();
}
...
if (action == slsDetectorDefs::GET_ACTION) {
if (args.size() == 0) {
if (cmd != "daclist" && det->getDetectorType().squash() != defs::CHIPTESTBOARD) { throw RuntimeError(cmd + " only allowed for CTB."); }
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (cmd != "daclist" && det->getDetectorType().squash() != defs::CHIPTESTBOARD) { throw RuntimeError(cmd + " only allowed for CTB."); }
if (cmd == "daclist" && det->getDetectorType().squash() != defs::CHIPTESTBOARD) { throw RuntimeError("This detector already has fixed dac names. Cannot change them."); }
if (det_id != -1) { throw RuntimeError("Cannot execute adclist at module level"); } 
...
os << R"V0G0N([0-31][name] 
		[ChipTestBoard] Set the adc at the given position to the given name. )V0G0N" << std::endl;
return os.str();
}
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 0) {
if (det_id != -1) { throw RuntimeError("Cannot execute bustest at module level"); } 
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 0) {
if (det_id != -1) { throw RuntimeError("Cannot execute clearroi at module level"); } 
...
defs::detectorType type = det->getDetectorType().squash(defs::GENERIC);;
if (type != defs::GOTTHARD2 && type != defs::MYTHEN3) { throw RuntimeError("clkphase not implemented for this detector."); }
if (args[1] != "deg") { throw RuntimeError("Cannot scan argument" + args[2] + ". Did you mean deg?"); }
auto arg0 = StringTo<int>(args[0]);
auto arg1 = StringTo<int>(args[1]);
...
if (args.size() == 1) {
defs::dacIndex dacIndex = (det->getDetectorType().squash() == defs::CHIPTESTBOARD && !is_int(args[0])) ? det->getDacIndex(args[0]) : StringTo<defs::dacIndex>(args[0]);
try {
StringTo<bool>("0");
} catch (...) {
  throw RuntimeError("Could not convert argument 1 to bool");
...
if (args.size() == 1) {
defs::dacIndex dacIndex = (det->getDetectorType().squash() == defs::CHIPTESTBOARD && !is_int(args[0])) ? det->getDacIndex(args[0]) : StringTo<defs::dacIndex>(args[0]);
if (args.size() > 0 && action != defs::HELP_ACTION && is_int(args[0]) && det->getDetectorType().squash() != defs::CHIPTESTBOARD) { throw RuntimeError("Dac indices can only be used for chip test board. Use daclist to get list of dac names for current detector."); }
auto arg1 = StringTo<bool>("0");
...
os << R"V0G0N([name] 
		[ChipTestBoard] Get the dac index for the given name. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([0-17][name] 
		[ChipTestBoard] Set the dac at the given position to the given name. )V0G0N" << std::endl;
return os.str();
}
...
StringTo<slsDetectorDefs::detectorSettings>(args[1]);
  ...
  throw RuntimeError("Could not convert argument 1 to slsDetectorDefs::detectorSettings");
}
}
...
StringTo<slsDetectorDefs::detectorSettings>(args[2]);
  ...
  throw RuntimeError("Could not convert argument 2 to slsDetectorDefs::detectorSettings");
}
}
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 0) {
if (det_id != -1) { throw RuntimeError("Cannot execute defaultpattern at module level"); } 
...
os << R"V0G0N([duration] [(optional unit) ns|us|ms|s]
	[Jungfrau][Moench][Gotthard][Mythen3][Gotthard2][Ctb][Moench] Delay after trigger )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([value]
	...
	[Jungfrau][Moench][Gotthard][Ctb][Mythen3][Gotthard2] 16 )V0G0N" << std::endl;
return os.str();
}
...
StringTo<slsDetectorDefs::externalSignalFlag>(args[1]);
  ...
  throw RuntimeError("Could not convert argument 1 to slsDetectorDefs::externalSignalFlag");
}
}
...
os << R"V0G0N(
	[Jungfrau][Moench][Gotthard][Mythen3][Gotthard2][Ctb] Firmware test, ie. reads a read fixed pattern from a register. )V0G0N" << std::endl;
return os.str();
}
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 0) {
if (det_id != -1) { throw RuntimeError("Cannot execute firmwaretest at module level"); } 
...
os << R"V0G0N([n_value]
	[Eiger][Jungfrau][Moench][CTB] Next frame number. Stopping acquisition might result in different frame numbers for different modules. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N(
	[Ctb][Mythen3] Gets the pattern file name including path of the last pattern uploaded. Returns an empty if nothing was uploaded or via a server default file )V0G0N" << std::endl;
return os.str();
}
...
os << '['<< ToStringHex(StringTo<int>(args[0]), 4)<< ", "<< ToStringHex(StringTo<int>(args[1]), 4)<< ']' << '\n';
}
...
os << R"V0G0N([64 bit mask]
	[Ctb][Mythen3] Selects the bits that will have a pattern mask applied to the selected patmask for every pattern. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([64 bit mask]
	[Ctb][Mythen3] Sets the mask applied to every pattern to the selected bits. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([fname]
	[Mythen3][Ctb] Loads ASCII pattern file directly to server (instead of executing line by line) )V0G0N" << std::endl;
return os.str();
}
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 0) {
if (det_id != -1) { throw RuntimeError("Cannot execute patternstart at module level"); } 
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 1) {
if (args[0] != "0") { throw RuntimeError("Unknown argument " + args[0] + ". Did you mean 0?"); }
...
os << R"V0G0N([0, 1]
	...
	[Mythen3][Gotthard2] Default is 1. If module not connected or wrong module, powerchip will fail. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([name] 
		[ChipTestBoard] Get the power index for the given name. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([powername1 powername2 .. powername4] 
		[ChipTestBoard] Set the list of power names for this board. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([0-4][name] 
		[ChipTestBoard] Set the power at the given position to the given name. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([name] 
		[ChipTestBoard] Get values of all powers. )V0G0N" << std::endl;
return os.str();
}
...
if (action == slsDetectorDefs::GET_ACTION) {
if (args.size() == 0) {
if (det->getDetectorType().squash() == defs::CHIPTESTBOARD) { throw RuntimeError("ReadoutSpeed not implemented. Did you mean runclk?"); }
...
os << R"V0G0N(
	[Jungfrau][Moench][Ctb][Gotthard][Mythen3][Gotthard2] Reboot controller of detector. )V0G0N" << std::endl;
return os.str();
}
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 0) {
if (det_id != -1) { throw RuntimeError("Cannot execute rebootcontroller at module level"); } 
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 0) {
if (det_id != -1) { throw RuntimeError("Cannot execute resetfpga at module level"); } 
...
os << R"V0G0N([analog|digital|analog_digital|transceiver|digital_transceiver]
	[CTB] Readout mode. Default is analog. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N(
	Current frame index received for receiver during acquisition. )V0G0N" << std::endl;
return os.str();
}
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 1) {
if (StringTo<int>(args[0]) != 0) { throw RuntimeError("Unknown argument " + args[0] + ". Did you mean 0?"); }
...
os << R"V0G0N([name] 
		[ChipTestBoard] Get the signal index for the given name. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([signalname1 signalname2 .. signalname63] 
		[ChipTestBoard] Set the list of signal names for this board. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([0-63][name] 
		[ChipTestBoard] Set the signal at the given position to the given name. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([name] 
		[ChipTestBoard] Get the slowadc index for the given name. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([slowadcname1 slowadcname2 .. slowadcname7] 
		[ChipTestBoard] Set the list of slowadc names for this board. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([0-7][name] 
		[ChipTestBoard] Set the slowadc at the given position to the given name. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([name] 
		[ChipTestBoard] Get values of all slow adcs. )V0G0N" << std::endl;
return os.str();
}
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 0) {
if (det_id != -1) { throw RuntimeError("Cannot execute start at module level"); } 
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 0) {
if (det_id != -1) { throw RuntimeError("Cannot execute stop at module level"); } 
...
os << R"V0G0N([0, 1]
	[Jungfrau][Moench] Enables or disables synchronization between modules. )V0G0N" << std::endl;
return os.str();
}
...
if (action == slsDetectorDefs::GET_ACTION) {
if (args.size() == 0) {
auto t = det->getTemperature(slsDetectorDefs::TEMPERATURE_10GE, std::vector<int>{ det_id });
os << OutString(t)<< " °C" << '\n';
}
...
if (action == slsDetectorDefs::GET_ACTION) {
if (args.size() == 0) {
auto t = det->getTemperature(slsDetectorDefs::TEMPERATURE_ADC, std::vector<int>{ det_id });
os << OutString(t)<< " °C" << '\n';
}
...
if (action == slsDetectorDefs::GET_ACTION) {
if (args.size() == 0) {
auto t = det->getTemperature(slsDetectorDefs::TEMPERATURE_DCDC, std::vector<int>{ det_id });
os << OutString(t)<< " °C" << '\n';
}
...
os << R"V0G0N([n_value]
	[Eiger][Jungfrau][Moench][Gotthard][Mythen3][Gotthard2] FPGA Temperature )V0G0N" << std::endl;
return os.str();
}
...
if (action == slsDetectorDefs::GET_ACTION) {
if (args.size() == 0) {
auto t = det->getTemperature(slsDetectorDefs::TEMPERATURE_FPGA, std::vector<int>{ det_id });
os << OutString(t)<< " °C" << '\n';
}
...
if (action == slsDetectorDefs::GET_ACTION) {
if (args.size() == 0) {
auto t = det->getTemperature(slsDetectorDefs::TEMPERATURE_FPGAEXT, std::vector<int>{ det_id });
os << OutString(t)<< " °C" << '\n';
}
...
if (action == slsDetectorDefs::GET_ACTION) {
if (args.size() == 0) {
auto t = det->getTemperature(slsDetectorDefs::TEMPERATURE_FPGA2, std::vector<int>{ det_id });
os << OutString(t)<< " °C" << '\n';
}
...
if (action == slsDetectorDefs::GET_ACTION) {
if (args.size() == 0) {
auto t = det->getTemperature(slsDetectorDefs::TEMPERATURE_FPGA3, std::vector<int>{ det_id });
os << OutString(t)<< " °C" << '\n';
}
...
if (action == slsDetectorDefs::GET_ACTION) {
if (args.size() == 0) {
auto t = det->getTemperature(slsDetectorDefs::SLOW_ADC_TEMP, std::vector<int>{ det_id });
os << OutString(t)<< " °C" << '\n';
}
...
if (action == slsDetectorDefs::GET_ACTION) {
if (args.size() == 0) {
auto t = det->getTemperature(slsDetectorDefs::TEMPERATURE_SODL, std::vector<int>{ det_id });
os << OutString(t)<< " °C" << '\n';
}
...
if (action == slsDetectorDefs::GET_ACTION) {
if (args.size() == 0) {
auto t = det->getTemperature(slsDetectorDefs::TEMPERATURE_SODR, std::vector<int>{ det_id });
os << OutString(t)<< " °C" << '\n';
}
...
os << R"V0G0N([bitmask]
	[Ctb] Transceiver Enable Mask. Enable for each 4 Transceiver channel. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N(
	[Gotthard][Jungfrau][Moench][Mythen3][Gotthard2][CTB] Number of triggers left in acquisition. Only when external trigger used. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([n_value]
	[CTB] Number of transceiver samples expected. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N(
	Returns detector type. Can be Eiger, Jungfrau, Gotthard, Moench, Mythen3, Gotthard2, ChipTestBoard )V0G0N" << std::endl;
return os.str();
}
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 0) {
if (det_id != -1) { throw RuntimeError("Cannot execute udp_cleardst at module level"); } 
...
if (det_id != -1) { throw RuntimeError("Cannot execute udp_dstlist at module level"); } 
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 1) {
if (rx_id < 0 || rx_id >= MAX_UDP_DESTINATION) { throw RuntimeError("Invalid receiver index to set round robin entry."); }
if (det_id != -1) { throw RuntimeError("Cannot execute udp_dstlist at module level"); } 
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 0) {
if (det_id != -1) { throw RuntimeError("Cannot execute udp_reconfigure at module level"); } 
...
if (action == slsDetectorDefs::PUT_ACTION) {
if (args.size() == 0) {
if (det_id != -1) { throw RuntimeError("Cannot execute udp_validate at module level"); } 
...
os << R"V0G0N([n_value]
	[Ctb] Power supply a in mV. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([n_value]
	[Ctb] Power supply b in mV. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([n_value]
	[Ctb] Power supply c in mV. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([n_value]
	[Ctb] Power supply d in mV. )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([n_value]
	[Ctb] Power supply io in mV. Minimum 1200 mV. Must be the first power regulator to be set after fpga reset (on-board detector server start up). )V0G0N" << std::endl;
return os.str();
}
...
os << R"V0G0N([n_value]
	[Ctb] Soft limit for power supplies (ctb only) and DACS in mV. )V0G0N" << std::endl;
return os.str();
}
