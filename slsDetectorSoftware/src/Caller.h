...
FunctionMap functions{{"activate", &Caller::activate},{"adcclk", &Caller::adcclk},{"adcenable", &Caller::adcenable},{"adcenable10g", &Caller::adcenable10g},{"adcinvert", &Caller::adcinvert},{"adcpipeline", &Caller::adcpipeline},{"apulse", &Caller::apulse},{"asamples", &Caller::asamples},{"autocompdisable", &Caller::autocompdisable},{"burstperiod", &Caller::burstperiod},{"cdsgain", &Caller::cdsgain},{"column", &Caller::column},{"compdisabletime", &Caller::compdisabletime},{"dbitclk", &Caller::dbitclk},{"dbitpipeline", &Caller::dbitpipeline},{"delay", &Caller::delay},{"delayl", &Caller::delayl},{"dpulse", &Caller::dpulse},{"dsamples", &Caller::dsamples},{"exptime", &Caller::exptime},{"exptime1", &Caller::exptime1},{"exptime2", &Caller::exptime2},{"exptime3", &Caller::exptime3},{"exptimel", &Caller::exptimel},{"extsampling", &Caller::extsampling},{"extsamplingsrc", &Caller::extsamplingsrc},{"fformat", &Caller::fformat},{"filtercells", &Caller::filtercells},{"filterresistor", &Caller::filterresistor},{"findex", &Caller::findex},{"fliprows", &Caller::fliprows},{"flowcontrol10g", &Caller::flowcontrol10g},{"fname", &Caller::fname},{"foverwrite", &Caller::foverwrite},{"fpath", &Caller::fpath},{"frames", &Caller::frames},{"frametime", &Caller::frametime},{"fwrite", &Caller::fwrite},{"gainmode", &Caller::gainmode},{"gates", &Caller::gates},{"highvoltage", &Caller::highvoltage},{"imagetest", &Caller::imagetest},{"interpolation", &Caller::interpolation},{"interruptsubframe", &Caller::interruptsubframe},{"led", &Caller::led},{"lock", &Caller::lock},{"master", &Caller::master},{"measuredperiod", &Caller::measuredperiod},{"measuredsubperiod", &Caller::measuredsubperiod},{"nextframenumber", &Caller::nextframenumber},{"numinterfaces", &Caller::numinterfaces},{"overflow", &Caller::overflow},{"parallel", &Caller::parallel},{"partialreset", &Caller::partialreset},{"patioctrl", &Caller::patioctrl},{"patmask", &Caller::patmask},{"patsetbit", &Caller::patsetbit},{"period", &Caller::period},{"periodl", &Caller::periodl},{"polarity", &Caller::polarity},{"port", &Caller::port},{"powerchip", &Caller::powerchip},{"pumpprobe", &Caller::pumpprobe},{"readnrows", &Caller::readnrows},{"romode", &Caller::romode},{"row", &Caller::row},{"runclk", &Caller::runclk},{"runtime", &Caller::runtime},{"rx_arping", &Caller::rx_arping},{"rx_dbitoffset", &Caller::rx_dbitoffset},{"rx_discardpolicy", &Caller::rx_discardpolicy},{"rx_fifodepth", &Caller::rx_fifodepth},{"rx_framesperfile", &Caller::rx_framesperfile},{"rx_lock", &Caller::rx_lock},{"rx_padding", &Caller::rx_padding},{"rx_silent", &Caller::rx_silent},{"rx_tcpport", &Caller::rx_tcpport},{"rx_udpsocksize", &Caller::rx_udpsocksize},{"rx_zmqfreq", &Caller::rx_zmqfreq},{"rx_zmqip", &Caller::rx_zmqip},{"rx_zmqport", &Caller::rx_zmqport},{"rx_zmqstartfnum", &Caller::rx_zmqstartfnum},{"rx_zmqstream", &Caller::rx_zmqstream},{"selinterface", &Caller::selinterface},{"settings", &Caller::settings},{"settingspath", &Caller::settingspath},{"stopport", &Caller::stopport},{"storagecell_delay", &Caller::storagecell_delay},{"storagecell_start", &Caller::storagecell_start},{"subdeadtime", &Caller::subdeadtime},{"subexptime", &Caller::subexptime},{"temp_control", &Caller::temp_control},{"temp_threshold", &Caller::temp_threshold},{"tengiga", &Caller::tengiga},{"timing", &Caller::timing},{"timingsource", &Caller::timingsource},{"top", &Caller::top},{"transceiverenable", &Caller::transceiverenable},{"trimval", &Caller::trimval},{"tsamples", &Caller::tsamples},{"txdelay_frame", &Caller::txdelay_frame},{"txdelay_left", &Caller::txdelay_left},{"txdelay_right", &Caller::txdelay_right},{"udp_dstmac", &Caller::udp_dstmac},{"udp_dstmac2", &Caller::udp_dstmac2},{"udp_dstport", &Caller::udp_dstport},{"udp_dstport2", &Caller::udp_dstport2},{"udp_firstdst", &Caller::udp_firstdst},{"udp_srcmac", &Caller::udp_srcmac},{"udp_srcmac2", &Caller::udp_srcmac2},{"updatemode", &Caller::updatemode},{"veto", &Caller::veto},{"zmqip", &Caller::zmqip},{"zmqport", &Caller::zmqport}};
