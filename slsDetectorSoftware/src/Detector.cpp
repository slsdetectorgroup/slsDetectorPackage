...
std::vector<defs::detectorSettings> Detector::getSettingsList() const {
    ...
    case defs::GOTTHARD:
        return std::vector<defs::detectorSettings>{
            ...
            defs::VERYHIGHGAIN};
    case defs::JUNGFRAU:
        return std::vector<defs::detectorSettings>{defs::GAIN0, defs::HIGHGAIN0};
    case defs::GOTTHARD2:defs::
        return std::vector<defs::detectorSettings>{
    ...
    case defs::MOENCH:
        ...
        defs::G1_HIGHGAIN, 
        defs::G1_LOWGAIN, 
        defs::G2_HIGHCAP_HIGHGAIN, 
        defs::G2_HIGHCAP_LOWGAIN, 
        defs::G2_LOWCAP_HIGHGAIN, 
        defs::G2_LOWCAP_LOWGAIN, 
        defs::G4_HIGHGAIN, 
        defs::G4_LOWGAIN};
