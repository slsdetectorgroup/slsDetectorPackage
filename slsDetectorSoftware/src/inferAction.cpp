...
int InferAction::infer(sls::CmdParser &parser, std::ostream &os ) {
  ...
  cmd = parser.command();
    ...
    if (it != functions.end()) {
        ...
        throw RuntimeError("det not implemented for command: " + parser.command());
...
if (args.size() == 0) {
throw RuntimeError("det is disabled for command: acquire with number of arguments 0. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: adclist. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: adcphase with number of arguments 1. Use detg or detp");
}
...
if (args.size() == 0) {
throw RuntimeError("det is disabled for command: adcvpp with number of arguments 0. Use detg or detp");
}

if (args.size() == 1) {
throw RuntimeError("det is disabled for command: adcvpp with number of arguments 1. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: badchannels. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: burstperiod with number of arguments 1. Use detg or detp");
}
...
if (args.size() == 2) {
throw RuntimeError("det is disabled for command: clkphase with number of arguments 2. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: compdisabletime with number of arguments 1. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: counters. Use detg or detp");
}
...
if (args.size() == 2) {
throw RuntimeError("det is disabled for command: dac with number of arguments 2. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: daclist. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: dbitphase with number of arguments 1. Use detg or detp");
}
...
if (args.size() == 2) {
throw RuntimeError("det is disabled for command: defaultdac with number of arguments 2. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: delay with number of arguments 1. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: execcommand. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: exptime with number of arguments 1. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: exptime1 with number of arguments 1. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: exptime2 with number of arguments 1. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: exptime3 with number of arguments 1. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: gaincaps. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: gatedelay with number of arguments 1. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: gatedelay1 with number of arguments 1. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: gatedelay2 with number of arguments 1. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: gatedelay3 with number of arguments 1. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: hostname. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: patlimits. Use detg or detp");
}

int InferAction::patloop() {

throw RuntimeError("det is disabled for command: patloop. Use detg or detp");
}

int InferAction::patloop0() {

throw RuntimeError("det is disabled for command: patloop0. Use detg or detp");
}

int InferAction::patloop1() {

throw RuntimeError("det is disabled for command: patloop1. Use detg or detp");
}

int InferAction::patloop2() {

throw RuntimeError("det is disabled for command: patloop2. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: patnloop. Use detg or detp");
}

int InferAction::patnloop0() {

throw RuntimeError("det is disabled for command: patnloop0. Use detg or detp");
}

int InferAction::patnloop1() {

throw RuntimeError("det is disabled for command: patnloop1. Use detg or detp");
}

int InferAction::patnloop2() {

throw RuntimeError("det is disabled for command: patnloop2. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: patwait. Use detg or detp");
}

int InferAction::patwait0() {

throw RuntimeError("det is disabled for command: patwait0. Use detg or detp");
}

int InferAction::patwait1() {

throw RuntimeError("det is disabled for command: patwait1. Use detg or detp");
}

int InferAction::patwait2() {

throw RuntimeError("det is disabled for command: patwait2. Use detg or detp");
}

int InferAction::patwaittime() {

throw RuntimeError("det is disabled for command: patwaittime. Use detg or detp");
}

int InferAction::patwaittime0() {

throw RuntimeError("det is disabled for command: patwaittime0. Use detg or detp");
}

int InferAction::patwaittime1() {

throw RuntimeError("det is disabled for command: patwaittime1. Use detg or detp");
}

int InferAction::patwaittime2() {

throw RuntimeError("det is disabled for command: patwaittime2. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: period with number of arguments 1. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: rx_dbitlist. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: rx_hostname. Use detg or detp");
}

int InferAction::rx_jsonaddheader() {

throw RuntimeError("det is disabled for command: rx_jsonaddheader. Use detg or detp");
}

int InferAction::rx_jsonpara() {

if (args.size() == 1) {
throw RuntimeError("det is disabled for command: rx_jsonpara with number of arguments 1. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: signallist. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: slowadclist. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: storagecell_delay with number of arguments 1. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: subdeadtime with number of arguments 1. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: subexptime with number of arguments 1. Use detg or detp");
}
...
if (args.size() == 1) {
throw RuntimeError("det is disabled for command: trimbits with number of arguments 1. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: vetostream. Use detg or detp");
}
...
throw RuntimeError("det is disabled for command: voltagelist. Use detg or detp");
}
