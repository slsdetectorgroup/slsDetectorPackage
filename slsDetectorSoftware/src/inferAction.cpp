...
if (args.size() == 0) {
throw RuntimeError("sls_detector is disabled for command: acquire with number of arguments 0. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: adclist. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: adcphase with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: adcvpp with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: badchannels. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: burstperiod with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 2) {
throw RuntimeError("sls_detector is disabled for command: clkphase with number of arguments 2. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: compdisabletime with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: counters. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 2) {
throw RuntimeError("sls_detector is disabled for command: dac with number of arguments 2. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: daclist. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: dbitphase with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 2) {
throw RuntimeError("sls_detector is disabled for command: defaultdac with number of arguments 2. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: delay with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: execcommand. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: exptime with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: exptime1 with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: exptime2 with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: exptime3 with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 0) {
throw RuntimeError("sls_detector is disabled for command: free with number of arguments 0. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: gaincaps. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: gatedelay with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: gatedelay1 with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: gatedelay2 with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: gatedelay3 with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: hostname. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: patlimits. Use sls_detector_get or sls_detector_put");
}

int InferAction::patloop() {

throw RuntimeError("sls_detector is disabled for command: patloop. Use sls_detector_get or sls_detector_put");
}

int InferAction::patloop0() {

throw RuntimeError("sls_detector is disabled for command: patloop0. Use sls_detector_get or sls_detector_put");
}

int InferAction::patloop1() {

throw RuntimeError("sls_detector is disabled for command: patloop1. Use sls_detector_get or sls_detector_put");
}

int InferAction::patloop2() {

throw RuntimeError("sls_detector is disabled for command: patloop2. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: patnloop. Use sls_detector_get or sls_detector_put");
}

int InferAction::patnloop0() {

throw RuntimeError("sls_detector is disabled for command: patnloop0. Use sls_detector_get or sls_detector_put");
}

int InferAction::patnloop1() {

throw RuntimeError("sls_detector is disabled for command: patnloop1. Use sls_detector_get or sls_detector_put");
}

int InferAction::patnloop2() {

throw RuntimeError("sls_detector is disabled for command: patnloop2. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: patwait. Use sls_detector_get or sls_detector_put");
}

int InferAction::patwait0() {

throw RuntimeError("sls_detector is disabled for command: patwait0. Use sls_detector_get or sls_detector_put");
}

int InferAction::patwait1() {

throw RuntimeError("sls_detector is disabled for command: patwait1. Use sls_detector_get or sls_detector_put");
}

int InferAction::patwait2() {

throw RuntimeError("sls_detector is disabled for command: patwait2. Use sls_detector_get or sls_detector_put");
}

int InferAction::patwaittime() {

throw RuntimeError("sls_detector is disabled for command: patwaittime. Use sls_detector_get or sls_detector_put");
}

int InferAction::patwaittime0() {

throw RuntimeError("sls_detector is disabled for command: patwaittime0. Use sls_detector_get or sls_detector_put");
}

int InferAction::patwaittime1() {

throw RuntimeError("sls_detector is disabled for command: patwaittime1. Use sls_detector_get or sls_detector_put");
}

int InferAction::patwaittime2() {

throw RuntimeError("sls_detector is disabled for command: patwaittime2. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: period with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: powerlist. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: rx_dbitlist. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: rx_hostname. Use sls_detector_get or sls_detector_put");
}

int InferAction::rx_jsonaddheader() {

throw RuntimeError("sls_detector is disabled for command: rx_jsonaddheader. Use sls_detector_get or sls_detector_put");
}

int InferAction::rx_jsonpara() {

if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: rx_jsonpara with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: rx_status. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: signallist. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: slowadclist. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: status. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: storagecell_delay with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: subdeadtime with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: subexptime with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
if (args.size() == 1) {
throw RuntimeError("sls_detector is disabled for command: trimbits with number of arguments 1. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: trimen. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: udp_dstlist. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: vetofile. Use sls_detector_get or sls_detector_put");
}
...
throw RuntimeError("sls_detector is disabled for command: vetoref. Use sls_detector_get or sls_detector_put");
}

int InferAction::vetostream() {

throw RuntimeError("sls_detector is disabled for command: vetostream. Use sls_detector_get or sls_detector_put");
}
