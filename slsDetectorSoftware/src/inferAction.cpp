...
int InferAction::acquire() {
    ...
    if (args.size() == 0) {
        throw RuntimeError(
            "det is disabled for command: acquire with number of "
...
int InferAction::adcphase() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: adcphase with number of "
...
int InferAction::burstperiod() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: burstperiod with number "
...
int InferAction::clkphase() {
    ...
    if (args.size() == 2) {
        throw RuntimeError(
            "det is disabled for command: clkphase with number of "
...
int InferAction::dbitphase() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: dbitphase with number of "
            "arguments 1. Use detg or detp");
    }
...
int InferAction::defaultdac() {
    ...
    if (args.size() == 2) {
        throw RuntimeError(
            "det is disabled for command: defaultdac with number of "
            "arguments 2. Use detg or detp");
    }
...
int InferAction::exptime() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: exptime with number of "
            "arguments 1. Use detg or detp");
    }
...
int InferAction::exptime1() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: exptime1 with number of "
            "arguments 1. Use detg or detp");
    }
...
int InferAction::exptime2() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: exptime2 with number of "
            "arguments 1. Use detg or detp");
    }
...
int InferAction::exptime3() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: exptime3 with number of "
            "arguments 1. Use detg or detp");
    }
...
int InferAction::gatedelay() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: gatedelay with number of "
            "arguments 1. Use detg or detp");
    }
...
int InferAction::gatedelay1() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: gatedelay1 with number of "
            "arguments 1. Use detg or detp");
    }
...
int InferAction::gatedelay2() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: gatedelay2 with number of "
            "arguments 1. Use detg or detp");
    }
...
int InferAction::gatedelay3() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: gatedelay3 with number of "
            "arguments 1. Use detg or detp");
    }
...
int InferAction::rx_jsonpara() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: rx_jsonpara with number "
            "of arguments 1. Use detg or detp");
    }
...
int InferAction::storagecell_delay() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: storagecell_delay with "
            "number of arguments 1. Use detg or detp");
    }
...
int InferAction::subdeadtime() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: subdeadtime with number "
            "of arguments 1. Use detg or detp");
    }
...
int InferAction::subexptime() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: subexptime with number of "
            "arguments 1. Use detg or detp");
    }
...
int InferAction::trimbits() {
    ...
    if (args.size() == 1) {
        throw RuntimeError(
            "det is disabled for command: trimbits with number of "
            "arguments 1. Use detg or detp");
    } else {
