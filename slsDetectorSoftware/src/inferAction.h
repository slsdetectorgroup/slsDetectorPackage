...
private:
  ...
  FunctionMap functions{
    ...
    { "fwrite", &InferAction::fwrite }, { "gaincaps", &InferAction::gaincaps },
    ...
    { "hostname", &InferAction::hostname }, { "im_a", &InferAction::im_a },
    { "im_b", &InferAction::im_b }, { "im_c", &InferAction::im_c },
    { "im_d", &InferAction::im_d }, { "im_io", &InferAction::im_io },
    ...
    { "trimbits", &InferAction::trimbits }, { "trimen", &InferAction::trimen },
    ...
    { "versions", &InferAction::versions }, { "veto", &InferAction::veto },
